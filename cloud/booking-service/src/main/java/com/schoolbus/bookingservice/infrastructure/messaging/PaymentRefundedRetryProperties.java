...
@ConfigurationProperties(
        prefix = "school-bus.messaging.payment-refunded-retry"
)
public record PaymentRefundedRetryProperties(
        String exchange,
        String routingKey,
        String queue,
        Duration delay,
    ...
    public PaymentRefundedRetryProperties {
