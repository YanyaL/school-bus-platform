...
class MyBatisConsumedEventRepositoryTest {
    ...
    @Test
    void shouldUsePositiveRedisProjectionWithoutQueryingMySql() {
    ...
    @Test
    void shouldFallBackToMySqlWhenRedisProjectionMisses() {
    ...
    @Test
    void shouldNotInsertAgainWhenRedisAlreadyKnowsCommittedEvent() {
        when(cache.contains("payment-refund", "event-1")).thenReturn(true);
